...
#---------------------------------------------
    ...
    def all_nodes_launch(context, robot_namespace):
        ...
        config_file_path = "/home/sf/workspace/orb_slam3_second_ws/orbslam/orbslam3_ros2_ws/src/orb_slam3_ros2_wrapper/params/orb_slam3_params/cyper_stereo.yaml"
        declare_params_file_cmd = DeclareLaunchArgument(
            'params_file',
            default_value=os.path.join(orb_wrapper_pkg, 'params', 'ros_params', 'cyper-stereo-ros-params.yaml'),
